 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tm;function mg(){if(Tm)return J;Tm=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),m=Symbol.for("react.consumer"),g=Symbol.for("react.context"),w=Symbol.for("react.forward_ref"),k=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),M=Symbol.for("react.lazy"),H=Symbol.iterator;function $(h){return h===null||typeof h!="object"?null:(h=H&&h[H]||h["@@iterator"],typeof h=="function"?h:null)}var X={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},le=Object.assign,oe={};function be(h,O,U){this.props=h,this.context=O,this.refs=oe,this.updater=U||X}be.prototype.isReactComponent={},be.prototype.setState=function(h,O){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,O,"setState")},be.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function qe(){}qe.prototype=be.prototype;function Ye(h,O,U){this.props=h,this.context=O,this.refs=oe,this.updater=U||X}var ue=Ye.prototype=new qe;ue.constructor=Ye,le(ue,be.prototype),ue.isPureReactComponent=!0;var ne=Array.isArray,K={H:null,A:null,T:null,S:null,V:null},Ue=Object.prototype.hasOwnProperty;function de(h,O,U,C,Y,se){return U=se.ref,{$$typeof:s,type:h,key:O,ref:U!==void 0?U:null,props:se}}function ye(h,O){return de(h.type,O,void 0,void 0,void 0,h.props)}function _(h){return typeof h=="object"&&h!==null&&h.$$typeof===s}function V(h){var O={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(U){return O[U]})}var ie=/\/+/g;function Ae(h,O){return typeof h=="object"&&h!==null&&h.key!=null?V(""+h.key):O.toString(36)}function dn(){}function Ze(h){switch(h.status){case"fulfilled":return h.value;case"rejected":throw h.reason;default:switch(typeof h.status=="string"?h.then(dn,dn):(h.status="pending",h.then(function(O){h.status==="pending"&&(h.status="fulfilled",h.value=O)},function(O){h.status==="pending"&&(h.status="rejected",h.reason=O)})),h.status){case"fulfilled":return h.value;case"rejected":throw h.reason}}throw h}function nn(h,O,U,C,Y){var se=typeof h;(se==="undefined"||se==="boolean")&&(h=null);var W=!1;if(h===null)W=!0;else switch(se){case"bigint":case"string":case"number":W=!0;break;case"object":switch(h.$$typeof){case s:case i:W=!0;break;case M:return W=h._init,nn(W(h._payload),O,U,C,Y)}}if(W)return Y=Y(h),W=C===""?"."+Ae(h,0):C,ne(Y)?(U="",W!=null&&(U=W.replace(ie,"$&/")+"/"),nn(Y,O,U,"",function(rt){return rt})):Y!=null&&(_(Y)&&(Y=ye(Y,U+(Y.key==null||h&&h.key===Y.key?"":(""+Y.key).replace(ie,"$&/")+"/")+W)),O.push(Y)),1;W=0;var mn=C===""?".":C+":";if(ne(h))for(var Te=0;Te<h.length;Te++)C=h[Te],se=mn+Ae(C,Te),W+=nn(C,O,U,se,Y);else if(Te=$(h),typeof Te=="function")for(h=Te.call(h),Te=0;!(C=h.next()).done;)C=C.value,se=mn+Ae(C,Te++),W+=nn(C,O,U,se,Y);else if(se==="object"){if(typeof h.then=="function")return nn(Ze(h),O,U,C,Y);throw O=String(h),Error("Objects are not valid as a React child (found: "+(O==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":O)+"). If you meant to render a collection of children, use an array instead.")}return W}function j(h,O,U){if(h==null)return h;var C=[],Y=0;return nn(h,C,"","",function(se){return O.call(U,se,Y++)}),C}function q(h){if(h._status===-1){var O=h._result;O=O(),O.then(function(U){(h._status===0||h._status===-1)&&(h._status=1,h._result=U)},function(U){(h._status===0||h._status===-1)&&(h._status=2,h._result=U)}),h._status===-1&&(h._status=0,h._result=O)}if(h._status===1)return h._result.default;throw h._result}var Z=typeof reportError=="function"?reportError:function(h){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var O=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof h=="object"&&h!==null&&typeof h.message=="string"?String(h.message):String(h),error:h});if(!window.dispatchEvent(O))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",h);return}console.error(h)};function Se(){}return J.Children={map:j,forEach:function(h,O,U){j(h,function(){O.apply(this,arguments)},U)},count:function(h){var O=0;return j(h,function(){O++}),O},toArray:function(h){return j(h,function(O){return O})||[]},only:function(h){if(!_(h))throw Error("React.Children.only expected to receive a single React element child.");return h}},J.Component=be,J.Fragment=o,J.Profiler=f,J.PureComponent=Ye,J.StrictMode=u,J.Suspense=k,J.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=K,J.__COMPILER_RUNTIME={__proto__:null,c:function(h){return K.H.useMemoCache(h)}},J.cache=function(h){return function(){return h.apply(null,arguments)}},J.cloneElement=function(h,O,U){if(h==null)throw Error("The argument must be a React element, but you passed "+h+".");var C=le({},h.props),Y=h.key,se=void 0;if(O!=null)for(W in O.ref!==void 0&&(se=void 0),O.key!==void 0&&(Y=""+O.key),O)!Ue.call(O,W)||W==="key"||W==="__self"||W==="__source"||W==="ref"&&O.ref===void 0||(C[W]=O[W]);var W=arguments.length-2;if(W===1)C.children=U;else if(1<W){for(var mn=Array(W),Te=0;Te<W;Te++)mn[Te]=arguments[Te+2];C.children=mn}return de(h.type,Y,void 0,void 0,se,C)},J.createContext=function(h){return h={$$typeof:g,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider=h,h.Consumer={$$typeof:m,_context:h},h},J.createElement=function(h,O,U){var C,Y={},se=null;if(O!=null)for(C in O.key!==void 0&&(se=""+O.key),O)Ue.call(O,C)&&C!=="key"&&C!=="__self"&&C!=="__source"&&(Y[C]=O[C]);var W=arguments.length-2;if(W===1)Y.children=U;else if(1<W){for(var mn=Array(W),Te=0;Te<W;Te++)mn[Te]=arguments[Te+2];Y.children=mn}if(h&&h.defaultProps)for(C in W=h.defaultProps,W)Y[C]===void 0&&(Y[C]=W[C]);return de(h,se,void 0,void 0,null,Y)},J.createRef=function(){return{current:null}},J.forwardRef=function(h){return{$$typeof:w,render:h}},J.isValidElement=_,J.lazy=function(h){return{$$typeof:M,_payload:{_status:-1,_result:h},_init:q}},J.memo=function(h,O){return{$$typeof:b,type:h,compare:O===void 0?null:O}},J.startTransition=function(h){var O=K.T,U={};K.T=U;try{var C=h(),Y=K.S;Y!==null&&Y(U,C),typeof C=="object"&&C!==null&&typeof C.then=="function"&&C.then(Se,Z)}catch(se){Z(se)}finally{K.T=O}},J.unstable_useCacheRefresh=function(){return K.H.useCacheRefresh()},J.use=function(h){return K.H.use(h)},J.useActionState=function(h,O,U){return K.H.useActionState(h,O,U)},J.useCallback=function(h,O){return K.H.useCallback(h,O)},J.useContext=function(h){return K.H.useContext(h)},J.useDebugValue=function(){},J.useDeferredValue=function(h,O){return K.H.useDeferredValue(h,O)},J.useEffect=function(h,O,U){var C=K.H;if(typeof U=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return C.useEffect(h,O)},J.useId=function(){return K.H.useId()},J.useImperativeHandle=function(h,O,U){return K.H.useImperativeHandle(h,O,U)},J.useInsertionEffect=function(h,O){return K.H.useInsertionEffect(h,O)},J.useLayoutEffect=function(h,O){return K.H.useLayoutEffect(h,O)},J.useMemo=function(h,O){return K.H.useMemo(h,O)},J.useOptimistic=function(h,O){return K.H.useOptimistic(h,O)},J.useReducer=function(h,O,U){return K.H.useReducer(h,O,U)},J.useRef=function(h){return K.H.useRef(h)},J.useState=function(h){return K.H.useState(h)},J.useSyncExternalStore=function(h,O,U){return K.H.useSyncExternalStore(h,O,U)},J.useTransition=function(){return K.H.useTransition()},J.version="19.1.0",J}var Dm;function js(){return Dm||(Dm=1,Qu.exports=mg()),Qu.exports}var en=js();const ms=kp(en);var $u={exports:{}},Xl={},Xu={exports:{}},Ku={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _m;function vg(){if(_m)return ln;_m=1;var s=js();function i(k){var b="https://react.dev/errors/"+k;if(1<arguments.length){b+="?args[]="+encodeURIComponent(arguments[1]);for(var M=2;M<arguments.length;M++)b+="&args[]="+encodeURIComponent(arguments[M])}return"Minified React error #"+k+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(){}var u={d:{f:o,r:function(){throw Error(i(522))},D:o,C:o,L:o,m:o,X:o,S:o,M:o},p:0,findDOMNode:null},f=Symbol.for("react.portal");function m(k,b,M){var H=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:f,key:H==null?null:""+H,children:k,containerInfo:b,implementation:M}}var g=s.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function w(k,b){if(k==="font")return"";if(typeof b=="string")return b==="use-credentials"?b:""}return ln.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=u,ln.createPortal=function(k,b){var M=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!b||b.nodeType!==1&&b.nodeType!==9&&b.nodeType!==11)throw Error(i(299));return m(k,b,null,M)},ln.flushSync=function(k){var b=g.T,M=u.p;try{if(g.T=null,u.p=2,k)return k()}finally{g.T=b,u.p=M,u.d.f()}},ln.preconnect=function(k,b){typeof k=="string"&&(b?(b=b.crossOrigin,b=typeof b=="string"?b==="use-credentials"?b:"":void 0):b=null,u.d.C(k,b))},ln.prefetchDNS=function(k){typeof k=="string"&&u.d.D(k)},ln.preinit=function(k,b){if(typeof k=="string"&&b&&typeof b.as=="string"){var M=b.as,H=w(M,b.crossOrigin),$=typeof b.integrity=="string"?b.integrity:void 0,X=typeof b.fetchPriority=="string"?b.fetchPriority:void 0;M==="style"?u.d.S(k,typeof b.precedence=="string"?b.precedence:void 0,{crossOrigin:H,integrity:$,fetchPriority:X}):M==="script"&&u.d.X(k,{crossOrigin:H,integrity:$,fetchPriority:X,nonce:typeof b.nonce=="string"?b.nonce:void 0})}},ln.preinitModule=function(k,b){if(typeof k=="string")if(typeof b=="object"&&b!==null){if(b.as==null||b.as==="script"){var M=w(b.as,b.crossOrigin);u.d.M(k,{crossOrigin:M,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0})}}else b==null&&u.d.M(k)},ln.preload=function(k,b){if(typeof k=="string"&&typeof b=="object"&&b!==null&&typeof b.as=="string"){var M=b.as,H=w(M,b.crossOrigin);u.d.L(k,M,{crossOrigin:H,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0,type:typeof b.type=="string"?b.type:void 0,fetchPriority:typeof b.fetchPriority=="string"?b.fetchPriority:void 0,referrerPolicy:typeof b.referrerPolicy=="string"?b.referrerPolicy:void 0,imageSrcSet:typeof b.imageSrcSet=="string"?b.imageSrcSet:void 0,imageSizes:typeof b.imageSizes=="string"?b.imageSizes:void 0,media:typeof b.media=="string"?b.media:void 0})}},ln.preloadModule=function(k,b){if(typeof k=="string")if(b){var M=w(b.as,b.crossOrigin);u.d.m(k,{as:typeof b.as=="string"&&b.as!=="script"?b.as:void 0,crossOrigin:M,integrity:typeof b.integrity=="string"?b.integrity:void 0})}else u.d.m(k)},ln.requestFormReset=function(k){u.d.r(k)},ln.unstable_batchedUpdates=function(k,b){return k(b)},ln.useFormState=function(k,b,M){return g.H.useFormState(k,b,M)},ln.useFormStatus=function(){return g.H.useHostTransitionStatus()},ln.version="19.1.0",ln}var Cm;function gg(){if(Cm)return Wu.exports;Cm=1;function s(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(s)}catch(i){console.error(i)}}return s(),Wu.exports=vg(),Wu.exports}/**
 * @license React
...
`,i+=`
# Ruffle Info
`,i+=`Version: ${On.versionNumber}
`,i+=`Name: ${On.versionName}
`,i+=`Channel: ${On.versionChannel}
`,i+=`Built: ${On.buildDate}
`,i+=`Commit: ${On.commitHash}
`,i+=`Is extension: ${_t}
`,i+=`
# Metadata
