...
public class Test extends Sprite {
    ...
    public function Test() {
        ...
        addChild(newTextField(20, true, "TestFontAboveAscent", 80));

        var aboveAscent = newTextField(20, true, "TestFontAboveAscent", 80);
        ...
        addChild(newTextField(20, true, "TestFontBelowDescent", 80));

        var belowDescent:TextField = newTextField(20, true, "TestFontBelowDescent", 80);
